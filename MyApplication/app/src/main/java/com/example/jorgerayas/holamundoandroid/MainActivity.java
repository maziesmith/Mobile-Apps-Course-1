package com.example.jorgerayas.holamundoandroid;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btnSaludar1OnClick(View view){
        //Mostrando un mensaje emergente con la clase Toast.
        Toast.makeText(this,"¡¡¡Hola Mundo desde Android!!!",Toast.LENGTH_LONG).show();
    }
    ...
    public void btnSaludar2OnClick(View view){
       //Recuperando el nombre del EditText
        ...
        //Modificando el texto del TextView
