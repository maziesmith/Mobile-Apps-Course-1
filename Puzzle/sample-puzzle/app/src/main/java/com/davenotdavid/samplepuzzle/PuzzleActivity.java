...
public class PuzzleActivity extends AppCompatActivity {
    ...
    private static void swap(final Context context, int currentPosition, int swap) {
        ...
        if (isSolved()) {
            ...
            dialog.setMessage("Ingresa tu nombre");
            ...
            dialog.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    intent.putExtra(ScoreActivity.SCORE_EXTRA,mMovements + "|"+editText.getText());
                    context.startActivity(intent);
                    ((PuzzleActivity)context).finish();
                }
            }).show();
            Toast.makeText(context, "YOU WIN! Movements: " +
                    "" + mMovements, Toast.LENGTH_SHORT).show();
